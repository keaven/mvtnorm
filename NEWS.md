...
- Added pkgdown article entries for the original Sweave vignettes and grouped
  the reference index into multivariate normal, t-distribution, algorithm, and
  matrix-function sections.
