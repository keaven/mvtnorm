...
backends, a useful reference trail is Sobol (1967) for the digital
sequence; Caflisch (1998), or Glasserman (2004, Chapter 6), for
quasi-Monte Carlo background and limitations; and Genz (1992), Genz and
Bretz (2002, 2009), and related mvtnorm references for the sequential
transformations and multivariate normal or \\t\\ probability algorithms.
BibTeX entries for these references are included in
`inst/REFERENCES.bib`.
